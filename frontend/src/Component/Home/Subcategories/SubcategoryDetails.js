...
const SubcategoryDetails = ({ propSelectedCity }) => {
    ...
    useEffect(() => {
        const fetchDataBySubcategory = async () => {
            ...
            try {
                const requests = [
                    axios.get("https://winkget-8.onrender.com/api/DealershipgetByCategory", {
                        params: { category: subcategory, subcategory: category }
                    }),
                    axios.get("https://winkget-8.onrender.com/api/FranchisegetByCategory", {
                        params: { category: subcategory, subcategory: category }
                    }),
                    axios.get("https://winkget-8.onrender.com/api/BusinessgetByCategory", {
                        params: { category: subcategory, subcategory: category }
                    }),
                ];
