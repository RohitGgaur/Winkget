...
const Dealership = ({ closeModal }) => {
    ...
    const fetchSubcategories = async () => {
      ...
      try {
        ...
        if (selectedCategory && Array.isArray(selectedCategory.subcategories)) {
          ...
          const response = await axios.get(`https://winkget-8.onrender.com/api/categories/${category}`);
  ...
  const handleDelete = async (did) => {
    ...
    try {
      await axios.delete(`https://winkget-8.onrender.com/api/Dealershipdelete/${did}`);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(`https://winkget-8.onrender.com/api/superadmin/${id}`);
  ...
  const fetchVender = async () => {
    try {
      const response = await axios.get('https://winkget-8.onrender.com/api/Dealershipget');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://winkget-8.onrender.com/api/Registerd', formData);
