...
const City = () => {
  ...
  const handleAddCity = async (e) => {
    ...
    try {
      const response = await axios.post('https://winkget-8.onrender.com/api/city', { name: cityName });
  ...
  const handleAddLocality = async (e) => {
    ...
    try {
      console.log(`API Request: https://winkget-8.onrender.com/api/city/${selectedCity}/locality`);
  
      const response = await axios.post(`https://winkget-8.onrender.com/api/city/${selectedCity}/locality`, {
        name: localityName,
      });
