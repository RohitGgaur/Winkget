...
const locations = useLocation();
  ...
  const fetchAdmins = async () => {
    try {
      const response = await axios.get('https://winkget-8.onrender.com/api/adminget');
  ...
  const handleDelete = async (adminid) => {
    ...
    try {
        await axios.delete(`https://winkget-8.onrender.com/api/delete/${adminid}`);
  ...
  const handlSubmit=async(e)=>{
    e.preventDefault();
    try {
      const response = await axios.post('https://winkget-8.onrender.com/api/fill', {
        category,
        subcategory,
        location,
        locality,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://winkget-8.onrender.com/api/Register', {
        name,
        position,
        city,
        email,
